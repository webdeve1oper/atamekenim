        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-3 mt-3">
                    <form action="{{route('partners')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <input type="text" placeholder="Название организаций" class="form-control" name="title">
                        <input type="file" class="form-control mt-3" name="image">
                        <input type="hidden" name="orders" value="{{$partners->count()}}">
                        ...
                        @foreach($partners as $partner)
                            <li class="ui-state-default mb-4"><img class="img-fluid" src="{{$partner->image}}" alt=""><br><br>
                                ...
                                <form action="{{route('update_partner')}}" method="post">
                                    @csrf
                                    <input type="text" name="partner_id" value="{{ $partner->id }}" class="d-none">
