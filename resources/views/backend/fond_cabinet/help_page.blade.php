            ...
            <div class="row">
                ...
                <div class="col-sm-5">
                    ...
                    <div class="infoBlock">
                        ...
                        <p><span>Место оказания помощи:</span>{{ $help->region->title_ru }} @if($help->city_id != null), {{ $help->city->title_ru }}@endif @if($help->district_id != null), {{ $help->city->title_ru }}@endif</p>
                        <p><span>ТЖС:</span>--</p>
