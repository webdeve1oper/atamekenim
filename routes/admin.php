...
Route::group(['prefix'=>'/admin','middleware'=>['auth:admin']], function(){
    ...
    Route::post('/return-to-moderate', 'Backend\AdminController@returnHelpToModerate')->name('return_to_moderate');
    Route::post('/finish-help', 'Backend\AdminController@finishHelpAction')->name('admin_finish_help');
    ...
    Route::get('/search', 'Backend\AdminController@globalSearch')->name('admin_helps_search');
});
